...
window.SITE_CONFIG = {
   ...
   */
  countries: [
    { name:'Namibia',        label:'Namibia',        color:'#fb923c', bg:'rgba(251,146,60,0.1)',  border:'rgba(217,119,6,0.5)',  gridBg:'rgba(251,146,60,0.07)',  gridBorder:'rgba(217,119,6,0.4)', spots:'Walvis Bay · Swakopmund',              pillDelay:'1.2s', dotDelay:'0.4s' },
    { name:'United Kingdom', label:'United Kingdom', color:'#818cf8', bg:'rgba(129,140,248,0.1)', border:'rgba(217,119,6,0.5)',  gridBg:'rgba(129,140,248,0.07)', gridBorder:'rgba(217,119,6,0.4)', spots:'Canford Cliffs · Heron Lake · Tooting Bec', pillDelay:'1.5s', dotDelay:'0.7s' },
    { name:'Australia',      label:'Australia',      color:'#34d399', bg:'rgba(52,211,153,0.1)',  border:'rgba(217,119,6,0.5)',  gridBg:'rgba(52,211,153,0.07)',  gridBorder:'rgba(217,119,6,0.4)', spots:'Cottesloe Beach · Perth',              pillDelay:'1.8s', dotDelay:'1.0s' },
    { name:'Switzerland',    label:'Switzerland',    color:'#fb7185', bg:'rgba(251,113,133,0.1)', border:'rgba(217,119,6,0.5)',  gridBg:'rgba(251,113,133,0.07)', gridBorder:'rgba(217,119,6,0.4)', spots:'Gland Plage · Promenthoux · Lake Geneva', pillDelay:'2.1s', dotDelay:'1.3s' },
    { name:'Portugal',       label:'Portugal',       color:'#fbbf24', bg:'rgba(251,191,36,0.1)',  border:'rgba(217,119,6,0.5)',  gridBg:'rgba(251,191,36,0.07)',  gridBorder:'rgba(217,119,6,0.4)', spots:'Cascais · Atlantic Coast',             pillDelay:'2.4s', dotDelay:'1.6s' },
    { name:'USA',            label:'USA',            color:'#60a5fa', bg:'rgba(96,165,250,0.1)',  border:'rgba(96,165,250,0.4)',  gridBg:'rgba(96,165,250,0.07)',  gridBorder:'rgba(217,119,6,0.4)', spots:'Aquatic Park · San Francisco Bay',     pillDelay:'2.8s', dotDelay:'1.9s' },
    { name:'Seychelles',     label:'Seychelles',     color:'#2dd4bf', bg:'rgba(45,212,191,0.1)',  border:'rgba(45,212,191,0.4)',  gridBg:'rgba(45,212,191,0.07)',  gridBorder:'rgba(217,119,6,0.4)', spots:'Mahé · Beau Vallon',                   pillDelay:'3.2s', dotDelay:'2.2s' },
    { name:'Italy',          label:'Italy',          color:'#a3e635', bg:'rgba(163,230,53,0.1)',  border:'rgba(163,230,53,0.4)',  gridBg:'rgba(163,230,53,0.07)',  gridBorder:'rgba(217,119,6,0.4)', spots:"Lago d'Orta",                          pillDelay:'3.6s', dotDelay:'2.5s' },
