...
| `emodnet` | **disabled** (Increment 2) | Probed 2026-08-17: public EMODnet ERDDAPs expose climatologies + sea-level NRT only — NO near-real-time water temperature. Superseded by `cmems_insitu`, which reads the same network at its source. |
